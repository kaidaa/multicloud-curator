...
export function SearchResultRow({ file }: SearchResultRowProps) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center gap-3 rounded-[--radius-sm] border border-line bg-panel px-3 py-2.5 text-left transition hover:border-line-strong hover:bg-panel-soft"
    >
