// Shape snake_case mirror Interface Contract §6.2. `path` dan `web_view_link`
...
const initialFiles: SecurityFileResponse[] = [
  {
    ...
    path: "1FolderArchive",
    web_view_link: "https://drive.google.com/file/d/fil-sec-001/view",
  },
  {
    id: "sec-002",
    file_id: "fil-sec-002",
    ...
    deletable_reason: null,
    path: "1FolderFinance",
    web_view_link: "https://drive.google.com/file/d/fil-sec-002/view",
  },
  {
    id: "sec-003",
    file_id: "fil-sec-003",
    ...
    web_view_link: "https://www.dropbox.com/home/Personal/Documents",
  },
  {
    id: "sec-004",
    file_id: "fil-sec-004",
    ...
    deletable_reason: null,
    path: "1FolderArchive",
    web_view_link: "https://drive.google.com/file/d/fil-sec-004/view",
  },
  {
    id: "sec-005",
    file_id: "fil-sec-005",
    ...
    web_view_link: "https://drive.google.com/file/d/fil-sec-005/view",
  },
  {
    id: "sec-006",
    file_id: "fil-sec-006",
    ...
    deletable_reason: null,
    path: "1FolderArchive",
    web_view_link: "https://drive.google.com/file/d/fil-sec-006/view",
  },
]
...
export function getMockSecurityResponse(mode: SecurityMode): SecurityResponse {
  ...
  return {
    ...
    meta: { scan_at: mockSecurityScanAt },
  }
}
